...
(function (a, b) {
	...
	var c = a.document, d = a.navigator, e = a.location, f = function () {
		...
		}), x = e.uaMatch(w), x.browser && (e.browser[x.browser] = !0, e.browser.version = x.version), e.browser.webkit && (e.browser.safari = !0), j.test("\xc2\xa0") && (k = /^[\s\xA0]+/, l = /[\s\xA0]+$/), h = e(c), c.addEventListener ? z = function () {
